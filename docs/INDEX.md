...
| [Ciclo de Vida Compartilhado dos Jogos](CICLO_DE_VIDA_DOS_JOGOS.md) | Levantamento da duplicação entre os 16 jogos, o que o *placeholder* (hoje `PlaceholderScreen`) cobria de fato e o desenho de `BaseGame` e do ajudante `TouchGrid` (o antigo `GridGame`) em `shared/`. |
